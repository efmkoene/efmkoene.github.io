...
for j=2:M
    ...
    % Update step
    uj_l(X) = r^2 * (c2*u2_l(X-2) + c1*u2_l(X-1) + c0*u2_l(X) ...
                    +c2*u2_l(X+2) + c1*u2_l(X+1))+ 2 *u2_l(X) - u1_l(X);
    ...
    % Update step
    uj_s(X2) = r^2*short^2 * (c2*u2_s(X2-2) + c1*u2_s(X2-1) + c0*u2_s(X2) ...
                             +c2*u2_s(X2+2) + c1*u2_s(X2+1))+ 2 *u2_s(X2) - u1_s(X2);
